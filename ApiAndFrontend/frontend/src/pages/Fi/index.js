...
const Fi = () => {
    ...
    const handleClickClientRate = (e) => {
        e.preventDefault();
        setIsLoading(true);
        history.push('/fi/clientrating');
        
    };
       
    const handleClickAccessRequest = e => {
        e.preventDefault();
        setIsLoading(true);
        history.push('/fi/idaccess');
    };
            ...
            <Box mx={'auto'} width={[1, 11 / 12, 10 / 12]}>
                <Flex px={2} mx={'auto'} justifyContent='space-between'>
                    ...
                    <Box my={'auto'}>
                        ...
                        <Button mr={2} onClick={handleClickAccessRequest}>Access Request</Button>
                        <Button mr={2} onClick={handleClickClientRate}>Client Rate</Button>
                    ...
                    <Flex my={1}>
                        <Box ml={10} my={1}>
                            {approvedClientList.length > 0 ?
                                <Heading as={'h3'} my={'auto'}>Your approved clients ID's:</Heading>
                                :
                        ...
                        <Flex mx={-3}>
                            <Box width={1} px={3}>
                                ...
                                <Box mb={2}>
                                    ...
                                    <Form.Check label="Email" value="email" onChange={handleClientFields} />
